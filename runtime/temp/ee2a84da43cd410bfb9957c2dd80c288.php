<?php /*a:1:{s:67:"/www/wwwroot/chat.qjshe.com/application/index/view/index/index.html";i:1572414280;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="layui-row layui-col-space20">
        <div class="layui-col-md8">
            <div class="layui-card">
                ...
                <div id="chatList" class="layui-card-body" style="height: 500px;overflow-y: scroll;overflow">
                </div>
            </div>
        </div>
...
<script>
    ws = new WebSocket("ws://chat.qjshe.com:7272");
    ...
    ws.onmessage = function(e){
        ...
        switch(type){
            ...
            case 'init':
                ...
                $.post('http://chat.qjshe.com/customer/login', {client_id: data.client_id}, function(data){}, 'json');
                break;
            case 'getMsg':
                // 利用jquery发起ajax请求，将client_id发给后端进行uid绑定
...
<script>
    layui.use('form', function(){
        ...
        form.on('submit(formDemo)', function(data){
            ...
            $.post('http://chat.qjshe.com/customer/sendMsg', data.field, function(data){}, 'json');
            return false;
        });
    });
</script>
