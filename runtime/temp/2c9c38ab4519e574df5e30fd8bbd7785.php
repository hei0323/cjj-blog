<?php /*a:1:{s:58:"D:\www\CQQ-Service\application\index\view\index\index.html";i:1572411303;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    ws.onmessage = function(e){
        ...
        switch(type){
            ...
            case 'init':
                ...
                $.post('http://127.0.0.1:8000/customer/login', {client_id: data.client_id}, function(data){}, 'json');
                break;
            case 'getMsg':
                // 利用jquery发起ajax请求，将client_id发给后端进行uid绑定
...
<script>
    layui.use('form', function(){
        ...
        form.on('submit(formDemo)', function(data){
            ...
            $.post('http://127.0.0.1:8000/customer/sendMsg', data.field, function(data){}, 'json');
            return false;
        });
    });
</script>
